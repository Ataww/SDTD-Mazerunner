...
Enfin, la webapp dialogue avec l'API MazeRunner sur l'URL /compute_recommendation/<username> pour demander au systeme de génerer des recommandations pour l'utilisateur fourni dans l'adresse.
